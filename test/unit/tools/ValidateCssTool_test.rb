...
class ValidateCssToolTest < ActiveSupport::TestCase
  
  sut = ValidateCssTool.new
  
  test "Response 'valid' should result in valid css for site" do
  ...
  test "Response'invalid' should result in invalid css for site" do
